#!/usr/bin/env bash
# Generic SLURM script for solver benchmark evaluation.

#SBATCH --job-name=sol-eval
#SBATCH --output=.logs/sol_eval/%x-%j.out
#SBATCH --error=.logs/sol_eval/%x-%j.err
...
echo "========================================"
echo "SLURM sol_eval"
echo "Job: ${SLURM_JOB_NAME:-sol-eval}"
