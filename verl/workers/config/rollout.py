...
class AgentLoopConfig(BaseConfig):
    ...
    def __post_init__(self):
        if self.progress_log_interval_seconds < 0:
            raise ValueError("`progress_log_interval_seconds` must be non-negative.")
        if self.progress_log_interval_samples < 0:
            raise ValueError("`progress_log_interval_samples` must be non-negative.")
